...
        [Tooltip("In full transparent AR, blur may mix with black color. This option may reduce the artifacts.")]
        ...
        ////[Header("Water")]
        //[Tooltip("Enables water effect")]
        //public bool EnableWater = false;
        //[Range(0, 1)]
        //public float DepthDensity = 0.36f;
        //[Range(0, 1)]
        //public float DistanceDensity = 0.02f;
        ////[Header(Waves)]
        ////float4 _WaveNormalMap_ST; //use _RefractionTex
        //public float WaveNormalScale = 25f;
        //public float WaveNormalSpeed = 0.05f;
        ////[Header(Base Color)]
        //public Color ShallowColor = new Color(1.15f, 1.29f, 0.88f);
        //public Color DeepColor = new Color(0.2f, 1f, 0.41f);
        //public Color FarColor = new Color(0.08f, 0.29f, 0.70f);
        ////[Header(Reflections)]
        //[Range(0, 1)]
        //public float ReflectionContribution = 0.5f;
        ////[HideInInspector][Header(Subsurface Scattering)]
        //public Color SSSColor = new Color(1f, 1f, 1f);
        ////[Header(Foam)]
        //[Range(0, 1)]
        //public float FoamContribution = 0.47f;
        //public Texture2D FoamTexture;
        //public float FoamScale = 4.41f;
        //public float FoamSpeed = 0.05f;
        //[Range(0, 1)]
        //public float FoamNoiseScale = 0.77f;
        ////[Header(Sun Specular)]
        //public Color SunSpecularColor = new Color(0.5f, 0.5f, 0.5f);
        //public float SunSpecularExponent = 40f;
        ////[Header(Sparkle)]
        //public Texture2D SparklesNormalMap;
        //public float SparkleScale = 9.8f;
        //public float SparkleSpeed = 0.01f;
        //public Color SparkleColor = new Color(0.74f, 1f, 0.93f);
        //public float SparkleExponent = 25000;
        ////[Header(Edge Foam)]
        //public Color EdgeFoamColor = new Color(1f, 1f, 1f);
        //public Texture2D EdgeFoamTexture;
        //public float EdgeFoamDepth = 0.2f;
        ////[Header(Shadow Mapping)]
        //// [Toggle(SHADOWS)]
        //public int FancyShadows = 0;
        //public float MaxShadowDistance = 50f;
        //public Color ShadowColor = new Color(1f, 1f, 1f);
        ////[Header(Vertex Waves Horizontal)]
        //[Range(0, 1)]
        //public float Wave1Direction = 0.382f;
        //public float Wave1Amplitude = 0.1f;
        //public float Wave1Wavelength = 5.43f;
        //public float Wave1Speed = 0.25f;
        ////[Header(Vertex Waves Vertical)]
        //[Range(0, 1)]
        //public float Wave2Direction = 0.61f;
        //public float Wave2Amplitude = 0.15f;
        //public float Wave2Wavelength = 3.6f;
        //public float Wave2Speed = 1f;
...
        //private Int64 _frameCount = 0; //to not draw for every X frame
        //private Int64 _lastRenderedFrame = 0; //if there are 2 or more cameras, script (begin camera rander fires more than once :) )
...
#else
        [NonSerialized]
        public LightweightRenderPipeline _pipeline;
#endif
        //use later as public
...
#else
            CommonRender(_pipeline, _context, _camera);
#endif
...
            {
            ...
            urpCamData = reflectionCamera.gameObject.GetComponent<UniversalAdditionalCameraData>();
            //Debug.Log("lwrp data");
            //Debug.Log(lwrpCamData);
            if (urpCamData == null)
            {
                urpCamData = reflectionCamera.gameObject
                    .AddComponent(typeof(UniversalAdditionalCameraData)) as UnityEngine.Rendering.Universal.UniversalAdditionalCameraData;
            }
            urpCamData.renderShadows = Shadow; // turn on-off shadows for the reflection camera
                                               //if (EnableWater)
                                               //{
                                               //    lwrpCamData.requiresColorOption = CameraOverrideOption.On;
...
#elif UNITY_2019_1_OR_NEWER
                LightweightRenderPipeline.RenderSingleCamera(manager == null ? _context : manager._context, reflectionCamera);
#else
                var cullResults = new CullResults();
                LightweightRenderPipeline.RenderSingleCamera(manager == null ? _pipeline : manager._pipeline,
                    manager == null ? _context : manager._context, reflectionCamera, ref cullResults);
#endif
                }
