...
#endif
	public sealed class RangeBuffLifetimeSystem : ISystemFilter
	{
		...
		{
			return Filter.Create("Filter-RangeBuffLifetimeSystem")
				.With<LifeTimeLeft>()
				.With<EffectTag>()
				.With<FiringRangeModifier>()
				.Push();
		}
		...
		void ISystemFilter.AdvanceTick(in Entity entity, in float deltaTime)
		{
			...
			avatar.Get<FiringRangeModifier>().Value -= entity.Read<SkillAmount>().Value;
			entity.Destroy();
		}
	}
}