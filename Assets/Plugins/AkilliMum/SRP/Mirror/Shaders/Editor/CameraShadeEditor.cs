...
namespace AkilliMum.SRP.Mirror
{
    ...
    public class CameraShadeEditor : Editor
    {
        ...
        //SerializedProperty EnableWater;
        ...
        void OnEnable()
        {
            ...
            //DepthDensity = serializedObject.FindProperty("DepthDensity");
            //DistanceDensity = serializedObject.FindProperty("DistanceDensity");
            //WaveNormalMap = serializedObject.FindProperty("RefractionTexture"); //use RefractionTexture !!!!
            //WaveNormalScale = serializedObject.FindProperty("WaveNormalScale");
            //WaveNormalSpeed = serializedObject.FindProperty("WaveNormalSpeed");
            //ShallowColor = serializedObject.FindProperty("ShallowColor");
            //DeepColor = serializedObject.FindProperty("DeepColor");
            //FarColor = serializedObject.FindProperty("FarColor");
            //ReflectionContribution = serializedObject.FindProperty("ReflectionContribution");
            //SSSColor = serializedObject.FindProperty("SSSColor");
            //FoamContribution = serializedObject.FindProperty("FoamContribution");
            //FoamTexture = serializedObject.FindProperty("FoamTexture");
            //FoamScale = serializedObject.FindProperty("FoamScale");
            //FoamSpeed = serializedObject.FindProperty("FoamSpeed");
            //FoamNoiseScale = serializedObject.FindProperty("FoamNoiseScale");
            //SunSpecularColor = serializedObject.FindProperty("SunSpecularColor");
            //SunSpecularExponent = serializedObject.FindProperty("SunSpecularExponent");
            //SparklesNormalMap = serializedObject.FindProperty("SparklesNormalMap");
            //SparkleScale = serializedObject.FindProperty("SparkleScale");
            //SparkleSpeed = serializedObject.FindProperty("SparkleSpeed");
            //SparkleColor = serializedObject.FindProperty("SparkleColor");
            //SparkleExponent = serializedObject.FindProperty("SparkleExponent");
            //EdgeFoamColor = serializedObject.FindProperty("EdgeFoamColor");
            //EdgeFoamTexture = serializedObject.FindProperty("EdgeFoamTexture");
            //EdgeFoamDepth = serializedObject.FindProperty("EdgeFoamDepth");
            //FancyShadows = serializedObject.FindProperty("FancyShadows");
            //MaxShadowDistance = serializedObject.FindProperty("MaxShadowDistance");
            //ShadowColor = serializedObject.FindProperty("ShadowColor");
            //Wave1Direction = serializedObject.FindProperty("Wave1Direction");
            //Wave1Amplitude = serializedObject.FindProperty("Wave1Amplitude");
            //Wave1Wavelength = serializedObject.FindProperty("Wave1Wavelength");
            //Wave1Speed = serializedObject.FindProperty("Wave1Speed");
            //Wave2Direction = serializedObject.FindProperty("Wave2Direction");
            //Wave2Amplitude = serializedObject.FindProperty("Wave2Amplitude");
            //Wave2Wavelength = serializedObject.FindProperty("Wave2Wavelength");
            //Wave2Speed = serializedObject.FindProperty("Wave2Speed");
        ...
        public override void OnInspectorGUI()
        {
            ...
            //if(EnableRefraction.boolValue)
            //{
            //    MenuRefraction = EditorGUILayout.BeginFoldoutHeaderGroup(MenuRefraction, new GUIContent { text = "Refraction" });
            //    if (MenuRefraction)
            //    {
            //        EditorGUILayout.PropertyField(RefractionTexture, new GUIContent { text = "Texture" });
            //        EditorGUILayout.PropertyField(Refraction, new GUIContent { text = "Density" });
            //    }
            //    EditorGUILayout.EndFoldoutHeaderGroup();
            //}
            ...
            //EditorGUILayout.Space();
            //MenuDepthBlur = EditorGUILayout.BeginFoldoutHeaderGroup(MenuDepthBlur, new GUIContent { text = "Depth Blur" });
            //if (MenuDepthBlur)
            //{
            //    EditorGUILayout.PropertyField(EnableDepthBlur, new GUIContent { text = "Enable" });
            //    if (EnableDepthBlur.boolValue)
            ...
            //EditorGUILayout.Space();
            //MenuSimpleDepthBlur = EditorGUILayout.BeginFoldoutHeaderGroup(MenuSimpleDepthBlur, new GUIContent { text = "Simple Depth" });
            //if (MenuSimpleDepthBlur)
            //{
            //    EditorGUILayout.PropertyField(EnableSimpleDepth, new GUIContent { text = "Enable" });
            //    if (EnableSimpleDepth.boolValue)
            //    {
            //        EditorGUILayout.PropertyField(SimpleDepthCutoff, new GUIContent { text = "Cutoff" });
            //    }
            //}
            //EditorGUILayout.EndFoldoutHeaderGroup();
            ...
            //EditorGUILayout.Space();
            //MenuFinalShader = EditorGUILayout.BeginFoldoutHeaderGroup(MenuFinalShader, new GUIContent { text = "Shader to Run on Final Texture" });
            //if (MenuFinalShader)
            //{
            //    EditorGUILayout.PropertyField(EnableFinalShader, new GUIContent { text = "Enable" });
            //    if (EnableFinalShader.boolValue)
            //    {
            //        EditorGUILayout.PropertyField(FinalShader, new GUIContent { text = "Shader" });
            //        EditorGUILayout.PropertyField(EnableARMode);
            //        EditorGUILayout.PropertyField(Iterations);
            //        EditorGUILayout.PropertyField(NeighbourPixels);
            ...
            //EditorGUILayout.Space();
            //MenuWaves = EditorGUILayout.BeginFoldoutHeaderGroup(MenuWaves, new GUIContent { text = "Waves" });
            //if (MenuWaves)
            //{
            //    EditorGUILayout.PropertyField(EnableWaves, new GUIContent { text = "Enable" });
            //    if (EnableWaves.boolValue)
            //    {
            //        EditorGUILayout.PropertyField(WaveNoiseTexture, new GUIContent { text = "Noise Texture" });
            //        EditorGUILayout.PropertyField(WaveSize, new GUIContent { text = "Size" });
            //        EditorGUILayout.PropertyField(WaveDistortion, new GUIContent { text = "Distortion" });
            //        EditorGUILayout.PropertyField(WaveSpeed, new GUIContent { text = "Speed" });
            //    }
            //}
            //EditorGUILayout.EndFoldoutHeaderGroup();
            ...
            //EditorGUILayout.Space();
            //MenuRipples = EditorGUILayout.BeginFoldoutHeaderGroup(MenuRipples, new GUIContent { text = "Ripples" });
            //if (MenuRipples)
            //{
            //    EditorGUILayout.PropertyField(EnableRipples, new GUIContent { text = "Enable" });
            //    if (EnableRipples.boolValue)
            //    {
            //        EditorGUILayout.PropertyField(RippleTexture, new GUIContent { text = "Texture" });
            //        EditorGUILayout.PropertyField(RippleSize, new GUIContent { text = "Size" });
            //        EditorGUILayout.PropertyField(RippleRefraction, new GUIContent { text = "Refraction" });
            //        EditorGUILayout.PropertyField(RippleDensity, new GUIContent { text = "Density" });
            //        EditorGUILayout.PropertyField(RippleSpeed, new GUIContent { text = "Speed" });
            //    }
            //}
            //EditorGUILayout.EndFoldoutHeaderGroup();
            ...
            //EditorGUILayout.Space();
            //MenuMasking = EditorGUILayout.BeginFoldoutHeaderGroup(MenuMasking, new GUIContent { text = "Masking" });
            //if (MenuMasking)
            //{
            //    EditorGUILayout.PropertyField(EnableMask, new GUIContent { text = "Enable" });
            //    if (EnableMask.boolValue)
            //    {
            //        EditorGUILayout.PropertyField(MaskTexture, new GUIContent { text = "Texture" });
            //        EditorGUILayout.PropertyField(MaskTiling, new GUIContent { text = "Tiling" });
            //        EditorGUILayout.PropertyField(MaskCutoff, new GUIContent { text = "Cutoff" });
            //        EditorGUILayout.PropertyField(MaskEdgeDarkness, new GUIContent { text = "Edge Darkness" });
            //    }
            //}
            //EditorGUILayout.EndFoldoutHeaderGroup();
            ...
            //if (MenuWater)
            //{
            //    EditorGUILayout.PropertyField(EnableWater, new GUIContent { text = "Enable" });
            //    if (EnableWater.boolValue)
            //    {
            //        EditorGUILayout.PropertyField(DepthDensity);
            //        EditorGUILayout.PropertyField(DistanceDensity);
            //        EditorGUILayout.PropertyField(WaveNormalMap);
            //        EditorGUILayout.PropertyField(WaveNormalScale);
            //        EditorGUILayout.PropertyField(WaveNormalSpeed);
            //        EditorGUILayout.PropertyField(ShallowColor);
            //        EditorGUILayout.PropertyField(DeepColor);
            //        EditorGUILayout.PropertyField(FarColor);
            //        EditorGUILayout.PropertyField(ReflectionContribution);
            //        EditorGUILayout.PropertyField(SSSColor);
            //        EditorGUILayout.PropertyField(FoamContribution);
            //        EditorGUILayout.PropertyField(FoamTexture);
            //        EditorGUILayout.PropertyField(FoamScale);
            //        EditorGUILayout.PropertyField(FoamSpeed);
            //        EditorGUILayout.PropertyField(FoamNoiseScale);
            //        EditorGUILayout.PropertyField(SunSpecularColor);
            //        EditorGUILayout.PropertyField(SunSpecularExponent);
            //        EditorGUILayout.PropertyField(SparklesNormalMap);
            //        EditorGUILayout.PropertyField(SparkleScale);
            //        EditorGUILayout.PropertyField(SparkleSpeed);
            //        EditorGUILayout.PropertyField(SparkleColor);
            //        EditorGUILayout.PropertyField(SparkleExponent);
            //        EditorGUILayout.PropertyField(EdgeFoamColor);
            //        EditorGUILayout.PropertyField(EdgeFoamTexture);
            //        EditorGUILayout.PropertyField(EdgeFoamDepth);
            //        EditorGUILayout.PropertyField(FancyShadows);
            //        EditorGUILayout.PropertyField(MaxShadowDistance); 
            //        EditorGUILayout.PropertyField(ShadowColor);
            //        EditorGUILayout.PropertyField(Wave1Direction);
            //        EditorGUILayout.PropertyField(Wave1Amplitude);
            //        EditorGUILayout.PropertyField(Wave1Wavelength);
            //        EditorGUILayout.PropertyField(Wave1Speed);
            //        EditorGUILayout.PropertyField(Wave2Direction);
            //        EditorGUILayout.PropertyField(Wave2Amplitude);
            //        EditorGUILayout.PropertyField(Wave2Wavelength);
            //        EditorGUILayout.PropertyField(Wave2Speed);
            //    }
            //}
            //EditorGUILayout.EndFoldoutHeaderGroup();
